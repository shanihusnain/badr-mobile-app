...
import type { MissedRamadanFastInsights } from "../missedRamadanFastsData";

type Props = {
  visible: boolean;
  insights: MissedRamadanFastInsights;
  onClose: () => void;
};

export function MissedRamadanFastsInsightsModal({
  visible,
  insights,
  onClose,
}: Props) {
        ...
        <View style={styles.sheet}>
          ...
          >
            ...
            <Text style={styles.congratsTitle}>
              {t("progressLogging.missedRamadanInsightsTitle", {
                count: insights.goalTarget,
              })}
            </Text>
            <Text style={styles.congratsBody}>
              {t("progressLogging.missedRamadanInsightsBody")}
            </Text>

            <View style={styles.statsCard}>
              <View style={styles.statRow}>
                <Text style={styles.statLabel}>
                  {t("progressLogging.missedRamadanLongestStreak")}
                </Text>
                <Text style={styles.statValue}>
                  {t("progressLogging.missedRamadanStreakDays", {
              ...
              <View style={styles.statRow}>
                <Text style={styles.statLabel}>
                  {t("progressLogging.missedRamadanWeeklyAverage")}
                </Text>
                <Text style={styles.statValue}>
                  {t("progressLogging.missedRamadanWeeklyAverageValue", {
