...
import { useLogDuhaPrayerGoal } from "@/src/api/mutations/useLogDuhaPrayerGoal";
...
export default function DuhaPrayerLoggingFlow({
  ...
  const { mutateAsync: logDuha, isPending: isLogging } = useLogDuhaPrayerGoal();
  ...
  const prayerType = resolvePrayerTypeFromGoalId(goalData.id) ?? "DUHA";
