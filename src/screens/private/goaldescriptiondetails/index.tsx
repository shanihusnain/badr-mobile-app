...
const renderReadMoreItem = (
  ...
  if (item.type === "prayerSection") {
    let PrayerIcon: React.ComponentType<{ color?: string; size?: number }> | null = null;
  ...
  if (item.type === "boldPrefixText") {
    ...
    let IconComp = null;
    if (item.icon === "MissedRamadanFastsPlatesIcon") IconComp = MissedRamadanFastsPlatesIcon;
    else if (item.icon === "QuranImageIcon") IconComp = QuranImageIcon;
    else if (item.icon === "ProphetDawoodFastsConnectionWithAllah") IconComp = ProphetDawoodFastsConnectionWithAllah;
    else if (item.icon === "ProphetDawoodFastsMoonAndHandIcon") IconComp = ProphetDawoodFastsMoonAndHandIcon;
    else if (item.icon === "ProphetDawoodFastsHeartIcon") IconComp = ProphetDawoodFastsHeartIcon;
    else if (item.icon === "ProphetDawoodMindfullnessIcon") IconComp = ProphetDawoodMindfullnessIcon;
    else if (item.icon === "ProphetDawoodGratitudeIcon") IconComp = ProphetDawoodGratitudeIcon;
    else if (item.icon === "ProphetDawoodMentalHealthIcon") IconComp = ProphetDawoodMentalHealthIcon;
    else if (item.icon === "ProphetDawoodHeartBreakIcon") IconComp = ProphetDawoodHeartBreakIcon;
    else if (item.icon === "ProphetDawoodPersonalDevelopmentIcon") IconComp = ProphetDawoodPersonalDevelopmentIcon;
    ...
    if (IconComp) {
      ...
      let iconSize = 30;
      return (
        <View key={`bold-prefix-${index}`} style={[{ flexDirection: "row", alignItems: "flex-start", width: "100%" }, spacingStyle]}>
  ...
  if (item.type === "boldSuffixText") {
    ...
    if (IconComp) {
      ...
      let iconSize = 30;
      return (
        <View key={`bold-suffix-${index}`} style={[{ flexDirection: "row", alignItems: "flex-start", width: "100%" }, spacingStyle]}>
          <View style={{ marginRight: 12, marginTop: 4 }}>
            <IconComp color={iconColor} size={iconSize} />
          </View>
          <View style={{ flex: 1 }}>
  ...
  if (item.type === "text" && item.icon === "FajarSunIcon") IconComponent = FajarSunIcon;
  else if (item.type === "text" && item.icon === "HadeethBookIcon") IconComponent = HadeethBookIcon;
  else if (item.type === "text" && item.icon === "DuhaPrayerStar") IconComponent = DuhaPrayerStar;
  else if (item.type === "text" && item.icon === "ManPrayerIcon") IconComponent = ManPrayerIcon;
  else if (item.type === "text" && item.icon === "QuranImageIcon") IconComponent = QuranImageIcon;
  else if (item.type === "text" && item.icon === "IstikharaClockIcon") IconComponent = IstikharaClockIcon;
  else if (item.type === "text" && item.icon === "ManDuaIcon") IconComponent = ManDuaIcon;
  else if (item.type === "text" && item.icon === "QuranListeningMoon") IconComponent = QuranListeningMoon;
  else if (item.type === "text" && item.icon === "QuranMemorizationIcon") IconComponent = QuranMemorizationIcon;
  else if (item.type === "text" && item.icon === "QuranTajweedIcon") IconComponent = QuranTajweedIcon;
  else if (item.type === "text" && item.icon === "MissedRamadanFastsHandsIcon") IconComponent = MissedRamadanFastsHandsIcon;
  else if (item.type === "text" && item.icon === "MissedRamadanFastsPlatesIcon") IconComponent = MissedRamadanFastsPlatesIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodFastsConnectionWithAllah") IconComponent = ProphetDawoodFastsConnectionWithAllah;
  else if (item.type === "text" && item.icon === "ProphetDawoodFastsMoonAndHandIcon") IconComponent = ProphetDawoodFastsMoonAndHandIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodFastsHeartIcon") IconComponent = ProphetDawoodFastsHeartIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodMindfullnessIcon") IconComponent = ProphetDawoodMindfullnessIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodGratitudeIcon") IconComponent = ProphetDawoodGratitudeIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodMentalHealthIcon") IconComponent = ProphetDawoodMentalHealthIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodHeartBreakIcon") IconComponent = ProphetDawoodHeartBreakIcon;
  else if (item.type === "text" && item.icon === "ProphetDawoodPersonalDevelopmentIcon") IconComponent = ProphetDawoodPersonalDevelopmentIcon;
  ...
  if (IconComponent) {
    ...
    if (item.type === "text") {
      if (item.icon === "FajarSunIcon") {
        ...
        iconSize = 30; // assuming standard icon color or let it default if we don't set it?
      } else if (item.icon === "IstikharaClockIcon") {
        iconColor = Colors.light.dullWhite; // Light purple/violet from the screenshot
        iconSize = 30;
