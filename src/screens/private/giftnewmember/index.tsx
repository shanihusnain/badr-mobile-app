                ...
                <View style={{ flex: 1, paddingBottom: 40 }}>
                    <View style={styles.content}>
                        ...
                        <Text style={styles.description}>
                            Get them started with a prepaid one-year Badr membership. Help them strengthen their worship, build better habits, and draw closer to Allah—one day at a time.
                        </Text>

                        <View style={styles.imagePlaceholder}>
                            <Text style={styles.imagePlaceholderText}>Mobile Image Space</Text>
                        </View>
                    </View>
                </View>
