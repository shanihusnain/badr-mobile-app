            ...
            <WarningModal
                ...
                message={
                    <Text style={{
                        ...
                        Your membership will remain active until <Text style={{ fontFamily: fonts.primary.bold, color: Colors.light.white }}>Nov 23, 2016.</Text> You'll continue to have access to <Text style={{ fontFamily: fonts.primary.bold, color: Colors.light.white }}>Badr</Text> until then, and no further charges will occur after your membership ends.
                    </Text>
                }
