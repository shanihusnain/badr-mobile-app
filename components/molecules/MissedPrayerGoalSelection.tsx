...
export default function MissedPrayerGoalSelection() {
  ...
  const handleSave = () => {
    console.log("Saved target Missed Prayers (days):", sliderValue, "prayers:", sliderValue * 5);
  };
    ...
    <View style={styles.container}>
      <TouchableOpacity style={styles.headerRow} onPress={toggleDropdown} activeOpacity={0.7}>
        <Text style={styles.titleText}>
          {t("prayerGoals.missedPrayersTitle")}
        </Text>
        <Feather
      ...
      {isOpen && (
        <View style={styles.expandedContent}>
          ...
          <Text style={styles.valueText}>
            ...
            <Text style={styles.whiteText}>{t("prayerGoals.missedPrayersSuffix")}</Text>
          </Text>
