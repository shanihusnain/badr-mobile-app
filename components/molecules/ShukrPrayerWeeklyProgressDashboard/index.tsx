...
export type ShukrPrayerDayProgress = {
  day: string;
  isLogged?: boolean;
...
export type ShukrPrayerWeeklyProgressDashboardProps = {
  weekDays: ShukrPrayerDayProgress[];
...
type DayRingProps = {
  size: number;
  day: ShukrPrayerDayProgress;
  isSelected: boolean;
};

function ShukrPrayerDayRing({
  size,
  day,
  isSelected,
}: DayRingProps) {
...
export function ShukrPrayerWeeklyProgressDashboard({
  ...
  streakDays = 7,
  motivationalQuote = "Your Shukr prayer is a beautiful act of gratitude. May Allah reward you.",
  selectedDayIndex = 6,
  statsIcon = "rug",
  onDayPress,
  onPrevWeek,
