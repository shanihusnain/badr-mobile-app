...
import {
  applyMondayThursdayAnalyticsView,
        ...
        {showCalendar ? (
          ...
          >
            <QuranHoursPastAchievementChartBlock
              ...
              chartKey={`monday-thursday-${period}-${analyticsView}-${refreshKey}`}
