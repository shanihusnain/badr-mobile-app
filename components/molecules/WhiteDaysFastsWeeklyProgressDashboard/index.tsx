...
import {
  ...
  whiteDaysFastDayLabelStyles,
} from "./whiteDaysFastDayStyles";
...
export function WhiteDaysFastsWeeklyProgressDashboard({
  ...
  const todayIndexInWeek = useMemo(
    () => getWhiteDaysFastTodayIndexInWeek(weekSummary.weekDays),
          ...
          return (
            ...
            >
              <View style={styles.dayItemWrapper}>
                <WhiteDaysFastDayRing size={ringSize} state={day.state} />
                <View
                  style={[
