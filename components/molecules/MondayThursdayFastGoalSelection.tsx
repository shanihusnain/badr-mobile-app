...
export default function MondayThursdayFastGoalSelection() {
    ...
    const handleSave = () => {
        console.log("Saved Monday & Thursday fasts with missed dates:", missedRamadanDates);
    };
                ...
                <View style={styles.expandedContent}>
                    ...
                    <View style={styles.calendarWrapper}>
                        <MonThuCalendar
                            ...
                            onSave={(count) => setMonThuCount(count)}
                        />
                    </View>
                    ...
                    <View style={styles.advisoryContainer}>
                        ...
                        <Text style={styles.advisoryText}>
                            You have the entire month to complete your fasting goal. If you happen to miss any planned fasting days, you can make them up on any Monday or Thursday that you have not already scheduled for fasting in this month.
                        </Text>
                    </View>
