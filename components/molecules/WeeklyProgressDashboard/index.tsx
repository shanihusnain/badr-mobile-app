...
const DUMMY_WEEK: DayProgress[] = [
    { day: "Sun", statuses: ["onTime", "onTime", "congregation", "missed", "none"] },
    { day: "Mon", statuses: ["onTime", "congregation", "onTime", "onTime", "none"] },
    { day: "Tue", statuses: ["missed", "onTime", "onTime", "congregation", "missed"] },
    { day: "Wed", statuses: ["onTime", "onTime", "onTime", "onTime", "onTime"] },
    { day: "Thu", statuses: ["congregation", "onTime", "missed", "onTime", "none"] },
    { day: "Fri", statuses: ["onTime", "congregation", "congregation", "onTime", "onTime"] },
...
export const WeeklyProgressDashboard: React.FC<WeeklyProgressDashboardProps> = ({
    weekDays = DUMMY_WEEK,
