...
export const GoogleIcon = () => {
  return (
    <Svg width={20} height={20} viewBox="0 0 48 48">
      ...
      <Path
        fill="#4CAF50"
        d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.3C29.2 35.1 26.7 36 24 36c-5.3 0-9.7-3.3-11.3-7.9l-6.5 5C9.6 39.6 16.3 44 24 44z"
      />
      <Path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.5 5.6-6.7 7.1l6.3 5.3C37.3 38.3 44 33 44 24c0-1.2-.1-2.3-.4-3.5z"
      />
    </Svg>
  );
};
